...
namespace Mic.Volo.MVCToDo.Services
{
    public class ToDoListService : IToDoListService<Guid, string>
    {
        ...
        public async Task<IEnumerable<Item<Guid, string>>> GetItemsAsync(OrderBy orderBy = OrderBy.None, int offset = 0, int limit = 10, bool? completed = null, string colorFilter = null, string titleFilter = null)
        {
